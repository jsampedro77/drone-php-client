...
class BuildsApi
{
     ...
     * @param string $owner owner of the repository (required)
     * @param string $name name of the repository (required)
     * @return array of \DroneClient\Build[], HTTP status code, HTTP response headers (array of strings)
     * @throws \InvalidArgumentException
     * @throws \DroneClient\ApiException on non-2xx response
     */
    public function reposOwnerNameBuildsGetWithHttpInfo($owner, $name)
    {
        $returnType = '\DroneClient\Build[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\DroneClient\Build[]', $e->getResponseHeaders());
